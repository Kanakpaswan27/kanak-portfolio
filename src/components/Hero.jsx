...
import heroVideo from '../assets/hero video/kanak-hero.mp4';
...
">
          ...
          <h1 
            data-aos="fade-up"
           className="text-white text-[34px] leading-[1.05] md:text-5xl font-bold mb-3 tracking-tight"
          >
          ...
          <p 
            data-aos="fade-up"
            data-aos-delay="200"
            className="text-white text-[15px] md:text-lg font-semibold mb-6 max-w-[320px] drop-shadow-md"
          >
        ...
        <div 
          data-aos="zoom-in"
          data-aos-delay="600"
          className="mt-5 md:mt-0 flex flex-row md:flex-col"
          onClick={toggleVideo}
        >
